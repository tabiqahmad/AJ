...
// Backend URL on Replit
const BACKEND_URL = 'https://hackbot--ekojegmd.replit.app';
...
const adminPassword = adminForm ? document.getElementById('adminPassword') : null;
const expirationDays = adminForm ? document.getElementById('expirationDays') : null;
const generatedKeyBox = document.getElementById('generatedKeyBox');
const generatedKey = generatedKeyBox ? document.getElementById('generatedKey') : null;
